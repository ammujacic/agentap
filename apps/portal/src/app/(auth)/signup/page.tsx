      ...
      <div className="max-w-sm w-full">
        <div className="text-center mb-8">
          <Link href="https://agentap.dev" className="inline-flex items-center gap-1 group">
            ...
            <span className="font-bold text-2xl text-white group-hover:gradient-text transition-all">
              agentap
            </span>
          </Link>
          <h1 className="mt-6 text-2xl font-bold text-white">Get started for free</h1>
          <p className="mt-2 text-gray-400">No credit card required. Free forever.</p>
        </div>
